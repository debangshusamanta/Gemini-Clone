      ...
      <div className="searchbox">
        ...
        <div className="down">
          <div className="images">
            <div className='div1'><img src="plus.png" alt="" /></div>
            <div className='div2'><img src="world.png" alt="" /><span>Deep Search</span></div>
            <div className='div3'><img src="tab.png" alt="" /><span>Canvas</span></div>
          </div>
          <div className="voice">
            <div><img className='img1' src="Microphone.png" alt="" /></div>
            <div onClick={Input ? onSent : null}><img className='img2' src="forword.png" alt="" /></div>
          </div>
        </div>
      </div>
    </div>
